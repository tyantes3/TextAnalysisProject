...
long_text = """Mr and Mrs Dursley, of number four, Privet Drive, were proud to
...
summary_ids_lst = [model.generate(inputs, num_beams=4, max_length=60, early_stopping=True) for inputs in inputs_batch_lst]
